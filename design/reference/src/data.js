/* ============================================================
   Synelia Cowork — données simulées
   Scénario : Direction Data & IA du Groupe Synelia.
   Une équipe partage des projets, des conversations et des
   routines avec l'IA, et voit en temps réel ce que font
   les autres dans chaque conversation.
   ============================================================ */
...
// ----- Projets partagés du département -----
const PROJECTS = [
  {
    id: "coris",
  ...
  },
  {
    ...
    created: "8 avril 2025",
    updated: "il y a 2 j",
    chats: 5,
    files: 11,
    routines: 3,
    artifacts: 2,
    public: true,   // espace public : accessible à tout le workspace (onboarding)
  },
];

// ----- Conversations à l'intérieur du projet Coris -----
const CHATS = {
  coris: [
    {
      id: "c-synthese",
      ...
      project: "coris",
      lastBy: "kofi",
      preview: "Peux-tu consolider les 12 constats en une matrice de risques…",
      updated: "maintenant",
      live: true,            // quelqu'un est en train d'utiliser cette conv
      liveUser: "kofi",
      liveState: "ai-typing", // l'IA répond en direct
      participants: ["awa", "kofi", "fatou"],
      pinned: true,
    },
    {
      id: "c-remediation",
      ...
      project: "coris",
      lastBy: "awa",
      preview: "Génère un plan en 3 vagues avec estimation de charge…",
      updated: "il y a 35 min",
      live: false,
      participants: ["awa", "yao"],
    },
    {
      id: "c-entretiens",
      ...
      project: "coris",
      lastBy: "fatou",
      preview: "Prépare 15 questions pour les responsables d'application…",
      updated: "il y a 2 h",
      live: true,
      liveUser: "fatou",
      liveState: "user-typing", // un coéquipier tape
      participants: ["awa", "fatou"],
    },
    {
      id: "c-conformite",
      ...
      project: "coris",
      lastBy: "kofi",
      preview: "Liste les écarts vis-à-vis du référentiel PCI-DSS v4…",
      updated: "hier",
      live: false,
      participants: ["awa", "kofi"],
    },
    {
      id: "c-archi",
      ...
      project: "coris",
      lastBy: "yao",
      preview: "Décris l'architecture applicative cible en couches…",
      updated: "il y a 2 j",
      live: false,
      participants: ["awa", "yao"],
    },
    {
      ...
      project: "coris",
      lastBy: "awa",
      preview: "Estime le budget de mise en conformité sur 18 mois…",
      updated: "il y a 3 j",
      live: false,
      participants: ["awa", "mariam"],
    },
  ],
};

// ----- Routines (tâches récurrentes avec l'IA) -----
// Chaque routine porte un prompt (l'instruction confiée à l'IA) et un historique
// d'exécutions (runs, le plus récent en tête) que l'on peut feuilleter.
const ROUTINES = [
  {
    id: "r1", title: "Veille cybersécurité hebdo", cadence: "Chaque lundi · 08:00", owner: "kofi", next: "Lun. 9 juin", project: "coris", icon: "radar",
    status: "active", ago: "il y a 2 j",
  ...
  },
  {
    ...
    runs: [
      { title: "État au 5 juin", date: "Ven. 5 juin 2026", ranFor: "5,9 s", thought: 3,
        output: "**Constats ouverts : 7 sur 12**\n\n- Critiques : 2\n- Élevés : 3\n- Modérés : 2\n\n**Clôturés cette semaine**\n\nDeux constats résolus : journalisation centralisée et revue des comptes de service.\n\n**À surveiller**\n\n1. Comptes à privilèges non revus — Critique\n2. Absence de PRA testé — Critique\n\n**Avancement global : 42 %**" },
      { title: "État au 29 mai", date: "Ven. 29 mai 2026", ranFor: "6,2 s", thought: 3,
        output: "**Constats ouverts : 9 sur 12**\n\n- Critiques : 3\n- Élevés : 4\n- Modérés : 2\n\n**Clôturés cette semaine**\n\nUn constat résolu : chiffrement des sauvegardes.\n\n**Avancement global : 25 %**" },
    ],
  },
  {
    id: "r3", title: "Synthèse d'avancement migration", cadence: "Chaque jeudi · 16:00", owner: "yao", next: "Jeu. 11 juin", project: "cnps", icon: "cloud-cog",
    status: "active", ago: "il y a 1 j",
    ...
    runs: [
      { title: "Avancement — S23", date: "Jeu. 4 juin 2026", ranFor: "6,7 s", thought: 4,
        output: "**Vague 2 en cours — 60 % migrée**\n\n3 applications basculées cette semaine (paie, RH, portail agent).\n\n**Point de blocage**\n\nLa dépendance à l'annuaire legacy retarde la bascule du module cotisations.\n\n**Prochaines bascules**\n\nModule cotisations prévu S24, sous réserve de la synchronisation annuaire." },
      { title: "Avancement — S22", date: "Jeu. 28 mai 2026", ranFor: "6,1 s", thought: 3,
        output: "**Vague 2 démarrée — 20 % migrée**\n\nMise en place de l'environnement cible terminée. Première application (portail agent) en recette.\n\n**Prochaines bascules**\n\nPaie et RH planifiées en S23." },
    ],
  },
  {
    id: "r4", title: "Revue des candidatures reçues", cadence: "Chaque lundi · 09:30", owner: "mariam", next: "Lun. 9 juin", project: "academy", icon: "users",
    status: "paused", ago: "il y a 5 j",
    ...
    runs: [
      { title: "Candidatures — S22", date: "Lun. 26 mai 2026", ranFor: "5,4 s", thought: 3,
        output: "**18 candidatures reçues**\n\n- Profils développeurs : 9\n- Profils data/analyse : 6\n- Reconversion : 3\n\n**Présélection**\n\n7 candidats remplissent les prérequis (SQL + Python + projet).\n\n**À programmer**\n\n7 entretiens techniques sur la semaine du 2 juin." },
    ],
  },
  {
    id: "r5", title: "Génération des supports de module", cadence: "Chaque mercredi · 14:00", owner: "fatou", next: "Mer. 10 juin", project: "academy", icon: "graduation-cap",
    status: "active", ago: "il y a 3 j",
    ...
    runs: [
      { title: "Module 4 — Pipelines de données", date: "Mer. 3 juin 2026", ranFor: "9,8 s", thought: 5,
        output: "**Module 4 — Pipelines de données**\n\n**Objectifs**\n\nConcevoir, orchestrer et superviser un pipeline batch et streaming.\n\n**Plan**\n\n1. Ingestion et formats\n2. Orchestration (Airflow)\n3. Qualité et tests de données\n4. Supervision et alerting\n\n**Évaluation**\n\nProjet fil rouge : pipeline d'ingestion de logs avec contrôle qualité." },
    ],
  },
  {
    id: "r6", title: "Rapport d'employabilité mensuel", cadence: "1er du mois · 08:00", owner: "mariam", next: "1 juil.", project: "academy", icon: "bar-chart-3",
    status: "active", ago: "il y a 5 j",
    ...
    runs: [
      { title: "Rapport — juin 2026", date: "Dim. 1 juin 2026", ranFor: "7,9 s", thought: 4,
        output: "**Taux d'insertion : 78 %**\n\nSur les 6 mois suivant la sortie, pour la promotion 2025.\n\n**Partenaires recruteurs**\n\nOrange CI, Sonatel, Coris Bank et 4 ESN locales ont recruté des diplômés.\n\n**Indicateurs**\n\n- Délai moyen d'insertion : 2,3 mois\n- Salaire d'entrée médian en progression de 12 %." },
    ],
  },
];

// ----- Fichiers / connaissances du projet -----
const FILES = [
  { id: "f1", name: "Cartographie SI — Coris.xlsx", type: "sheet", size: "284 Ko", by: "yao", when: "il y a 2 j", icon: "table-2" },
  { id: "f2", name: "Politique de sécurité v3.pdf",  type: "pdf",   size: "1,2 Mo", by: "kofi", when: "il y a 2 j", icon: "file-text" },
  { id: "f3", name: "Entretien DSI — notes.docx",    type: "doc",   size: "48 Ko",  by: "fatou", when: "hier",      icon: "file-text" },
  { id: "f4", name: "Référentiel PCI-DSS v4.pdf",    type: "pdf",   size: "3,4 Mo", by: "kofi", when: "hier",      icon: "file-text" },
  { id: "f5", name: "Inventaire applicatif.csv",      type: "sheet", size: "92 Ko",  by: "yao", when: "il y a 3 j", icon: "table-2" },
];

// ----- Artefacts produits par l'IA (tous projets) -----
const ARTIFACTS = [
...
// ----- Flux d'activité du département (temps réel) -----
const ACTIVITY = [
...
// ----- Conversation pré-existante de « Synthèse des constats » -----
// (l'IA est en train de répondre en direct quand on ouvre cette conv)
const THREAD_SYNTHESE = [
  {
    id: "m1", author: "fatou", role: "user", at: "10:02",
    ...
    attachments: [{ name: "Entretien DSI — notes.docx", icon: "file-text" }, { name: "Inventaire applicatif.csv", icon: "table-2" }],
  },
  {
    id: "m2", author: "ai", role: "assistant", at: "10:03",
    text: "Bien reçu. J'ai parcouru les notes et l'inventaire. Je relève **12 constats** que je peux regrouper en 4 familles : gouvernance des accès, obsolescence applicative, sauvegarde/PRA, et conformité PCI-DSS.\n\nSouhaitez-vous que je les consolide dans une matrice de risques (probabilité × impact) avec une cotation par constat ?",
  },
  {
    id: "m3", author: "kofi", role: "user", at: "10:05",
    text: "Oui, parfait. Ajoute une colonne « propriétaire » et une cotation sur 4 niveaux. Priorise pour le COPIL de vendredi.",
  },
  // m4 = réponse de l'IA streamée en direct (gérée par le moteur temps réel)
];

// Le texte que l'IA "tape" en direct quand on ouvre la conv Synthèse
const LIVE_AI_REPLY =
...
// ----- Bibliothèque de prompts partagée du département -----
// Catégories
const PROMPT_CATS = [
...
window.SYN = { TEAM, ME, PROJECTS, CHATS, ROUTINES, FILES, ARTIFACTS, ACTIVITY, THREAD_SYNTHESE, LIVE_AI_REPLY, PROMPT_CATS, PROMPTS };
